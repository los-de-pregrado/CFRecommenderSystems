...
plt.plot(gammas, mclaughlin_1_fcp_values, 'y', label='McLaughlin k=20 FCP')
plt.plot(gammas[mclaughlin_1_max_index], mclaughlin_1_fcp_values[mclaughlin_1_max_index], 'yo')
plt.plot(gammas, mclaughlin_2_fcp_values, 'm', label='McLaughlin k=25 FCP')
plt.plot(gammas[mclaughlin_2_max_index], mclaughlin_2_fcp_values[mclaughlin_2_max_index], 'mo')
plt.plot(gammas, mclaughlin_3_fcp_values, 'r', label='McLaughlin k=30 FCP')
