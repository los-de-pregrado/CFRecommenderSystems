...
# k_value_mclaughlin_4 = 30
# k_value_mclaughlin_5 = 25
# k_value_mclaughlin_6 = 30
...
plt.ylabel('Error')
plt.xlabel('Gama (Y)')
plt.xticks(np.arange(min(gammas), max(gammas)+1, 5.0))
plt.legend(loc='best')
plt.savefig('../results/mclaughlin-rmse-item.png')
plt.show()
