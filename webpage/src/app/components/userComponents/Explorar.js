...
export default class Explorar extends Component {
  ...
  incrementItem(itemId, itemCount) {

  }

  decrementItem(itemId, itemCount) {
  ...
  render() {
    return (
      <Container>
        <Row>
          <Col s={12}>
            <h2>Lista Numero Uno</h2>
          </Col>
          <Col s={12}>
            <ItemList pagination
              artists={this.state.artistas}
